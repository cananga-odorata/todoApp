...
func (sq *SettingsQuery) QueryUserOwner() *UserQuery {
...
func (sq *SettingsQuery) WithUserOwner(opts ...func(*UserQuery)) *SettingsQuery {
	query := (&UserClient{config: sq.config}).Query()
...
func (sq *SettingsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Settings, error) {
	...
	if query := sq.withUserOwner; query != nil {
		if err := sq.loadUserOwner(ctx, query, nodes, nil,
			func(n *Settings, e *User) { n.Edges.UserOwner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *SettingsQuery) loadUserOwner(ctx context.Context, query *UserQuery, nodes []*Settings, init func(*Settings), assign func(*Settings, *User)) error {
