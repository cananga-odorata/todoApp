...
func HasTaskWith(preds ...predicate.Task) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newTaskStep()
...
func HasReportWith(preds ...predicate.Report) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newReportStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasSettingsWith(preds ...predicate.Settings) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasSharing() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSharingWith(preds ...predicate.Sharing) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSharingStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasNotification() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasNotificationWith(preds ...predicate.Notification) predicate.User {
	return predicate.User(func(s *sql.Selector) {
